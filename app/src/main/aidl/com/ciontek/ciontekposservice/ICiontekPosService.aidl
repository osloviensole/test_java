...
/*---------------------------  Fiscal APIs -------------------------------------------------------*/
    ...
    //6.0.4
     ...
     int Lib_SetFontTTF(in String filename,byte FontWeight, byte FontHeight);
     int Lib_SetDirection(byte direction);
     int Lib_PrintTableText(in String[] texts,in int[] widths,in int[] align);
     int Lib_PrintSetItalic(int mode);
}
